...
if ($variable==1) {
?>
<script type="text/javascript">alert("UserName and Password NOT FOUND!")</script>
<?php
}
else  if ($variable==2)
{
?>
<script type="text/javascript">alert("You have not access to this page. Please Login")</script>
<?php
}
else
?>
...
<!DOCTYPE html>
<!-- saved from url=(0096)http://red-team-design.com/wp-content/uploads/2011/09/slick-login-form-with-html5-css3-demo.html -->
