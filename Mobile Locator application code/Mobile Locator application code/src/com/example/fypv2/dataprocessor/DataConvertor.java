...
import com.example.fypv2.datasource.DataSource.TYPE;
...
public class DataConvertor {
	//addDefaultDataProcessors, add mobilelocator data processor
	...
	private void addDefaultDataProcessors(){
		...
		dataProcessors.add(new MbLocatorDataProcessor());
	}
