 ...
 */
public class ActState implements MixStateInterface{
	//mixare version, with new constructor
	public static int NOT_STARTED = 0; 
	public static int PROCESSING = 1; 
	public static int READY = 2; 
	public static int DONE = 3; 

	int nextLStatus = ActState.NOT_STARTED;
	String downloadId;
	...
	public ActState() {
		nextLStatus = ActState.NOT_STARTED;
	}
