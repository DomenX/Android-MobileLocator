...
public class DataSource extends Activity {
	...
	public enum TYPE {
		WIKIPEDIA, BUZZ, TWITTER, OSM, MIXARE, ARENA,MOBILE_LOCATOR
	};
	...
	public String createSearchRequestParams(String searchString, String searchCategory) {
		String output = "";
		...
		if (searchCategory !="" || searchCategory != null) {
			...
			case MOBILE_LOCATOR:
				output += "&category=" + searchCategory;
				break;
			default:
				break;
			}
