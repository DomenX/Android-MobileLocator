...
public interface DataSourceManager {
	...
	/**
	 * same with requestDataFromAllActiveDataSource, but it required user to insert 
	 * search keyword and search category
	 *
	 * @param search
	 * @param category
	 * @param lat
	 ...
	 * @param radius
	 */
	void requestSearchDataFromAllActiveDataSource(String search , String category , 
