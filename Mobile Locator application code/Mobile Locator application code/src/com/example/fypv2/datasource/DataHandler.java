...
public class DataHandler {
	...
	public void addMarkers(List<Marker> markers) {
		...
		Log.v(MainFrame.TAG, "Marker before: "+markerList.size());

		for(Marker ma:markers) {
			if(!markerList.contains(ma))
				markerList.add(ma);
		}
		Log.d(MainFrame.TAG, "Marker count: "+markerList.size());
	}
	...
	public void updateActivationStatus(MainContext mixContext) {
