...
public final class HttpTools {
	...
	public static String getPageContent(String request, ContentResolver cr) throws Exception {
		String pageContent;
		InputStream is = null;
		
		if(!request.startsWith("file://")){
			is = HttpTools.getHttpGETInputStream(request, cr);
		}else{
			is = HttpTools.getHttpGETInputStream(request, cr);
		}
	...
	public static InputStream getHttpGETInputStream(String urlStr, ContentResolver cr ) throws Exception {
		...
		try {
			...
			try {
				...
				Log.w(MainFrame.TAG, "Error on url "+urlStr, ignore);
			}
			try {
